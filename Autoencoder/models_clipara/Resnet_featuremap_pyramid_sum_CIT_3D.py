...
class ResDecoder(nn.Module):
    def __init__(self,
        ...
        #self.conv1 = SeparableTransConv7x7x7(self.inplanes, output_channel, output_pad=[1, 1, 1])
        self.conv1 = SeparableTransConv7x7x7(self.inplanes, output_channel, output_pad=[0, 1, 1])
